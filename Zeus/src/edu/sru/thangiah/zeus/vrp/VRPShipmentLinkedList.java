...
import edu.sru.thangiah.zeus.optimizations.sfc.selectionheuristics.SFCInvalidGenerationException;
...
//private int method = VRPSpaceFillingCurve.SquareCurve;
...
* @ param currDepot VRPDepot
* @ param currShipLL VRPShipmentLinkedList
* @ return VRPShipment
*/
...
temp = (VRPShipment) currShipLL.getVRPHead().getNext(); //point to the first shipment
