...
//----Test section
		...
		for(int g=1; g<totalGen; g++) {
			...
			System.out.println("current fittest cost: " + newPop.getChromosomes().getFirst().getTspCost());
			//System.out.println("getf cost " + newPop.calculateFittestChromosome().getTspCost());
		}
