    ...
    if(ProblemInfo.distanceMatrix == null) {	
      ...
      //==========
	      ...
	      try {
	    	 ...
	    	 templeft = left.getIndex();
	         tempright = right.getIndex();
	         
	         distTravelled += DistanceArray[templeft][tempright];
	         //System.out.println("TTTTTTTTTTTTTTTTTTTTTTTT " + templeft + " " + tempright);
	         //System.out.println("FFFF " + distTravelled);
