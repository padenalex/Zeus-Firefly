...
public class FFShipment
  ...
  public FFShipment(int i, float x, float y, int d, int q, int e, String t) {
	    //super(i, x, y, q, d, t, p);
	    setIndex(i);
	    setXCoord(x);
	    setYCoord(y);
   ...
   */
  public FFShipment(int i, double x, double y, float q, float d, String t,
                     String p) {
    //super(i, x, y, q, d, t, p);
    setIndex(i);
    setXCoord(x);
  ...
  public FFShipment(int i, float x, float y, int d, int q, int e, int comb,
		  String t,
  ...
  //calls the super in shipment
  public FFShipment(int i, int x, int y, int d, int q, int e, int comb,
		  String t,
		  int[] vComb, int[][] cuComb) {
	  //super(ind, x, y, d, q, e, comb, t, vComb, cuComb);
	  //serviceTime = d;
  ...
  public double getExtraVariable() {
    ...
    //but return it as a FFShipment
    return extraVariable;
  }
  
  public Object clone() {
		FFShipment clonedShipment = new FFShipment();
